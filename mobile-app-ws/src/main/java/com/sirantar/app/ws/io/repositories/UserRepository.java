...
public interface UserRepository extends PagingAndSortingRepository<UserEntity, Long> {
  ...
  @Query(value = "select u.first_name, u.last_name from Users u where u.first_name like %:keyword% or u.last_name LIKE %:keyword%",
         nativeQuery = true)
  List<Object[]> findUserFirtNameAndLastNameByKeyword(@Param("keyword") String keyword);
  ...
  // JPQL use entity names, not database
  ...
  void updataUserEntityEmailVerificationStatus(@Param("emailVerificationStatus") boolean emailVerificationStatus,
    @Param("userId") String userId);
}
